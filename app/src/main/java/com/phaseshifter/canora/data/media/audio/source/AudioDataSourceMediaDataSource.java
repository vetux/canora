...
public class AudioDataSourceMediaDataSource implements AudioDataSource, Serializable {
    ...
    public MediaSource getExoPlayerSource(Context context) throws Exception {
        if (android.os.Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            throw new UnsupportedOperationException("MediaDataSource is unavailable below API 23");
        } else {
            ...
            return new ProgressiveMediaSource.Factory(factory).createMediaSource(null);
        }
    }
